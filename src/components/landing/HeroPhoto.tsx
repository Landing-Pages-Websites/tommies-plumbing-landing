...
export function HeroPhoto(): ReactElement {
  return (
    <figure className="relative order-2 overflow-hidden rounded-card shadow-lift lg:order-none lg:col-span-7 lg:row-start-2">
      <Image src="/brand/photos/hero.jpg" alt="Plumber servicing a wall-mounted tankless water heater in a home laundry room" width={1344} height={768} priority sizes="(min-width: 1024px) 680px, 100vw" className="aspect-[16/7] h-auto w-full object-cover object-[center_40%] sm:aspect-[16/9]" />
